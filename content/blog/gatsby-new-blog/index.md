...
ただブロックエディターになってから、文章を書くよりも体裁を整える方に時間がかかってしまうようになりまいした。

**Gitで記事を管理したい**
フォルダに記事を登録したら、記事が自動で公開されるようにしたい。Gitで記事の変更履歴を残したい。
...
サンプルテーマそのままであれば簡単だけど、やっぱり、検索機能をつけたいとか、カテゴリーやタグページとか機能を足そうとすると、やり方を調べつつなので時間がかかります。
